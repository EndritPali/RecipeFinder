...
import { EditCommentPayload, ToggleLikePayload } from '@/types/comment';
...
export function useCommentMutations() {
    ...
    const editComment = useMutation<Comment, Error, EditCommentPayload>({
    ...
    const toggleLike = useMutation<Comment, Error, ToggleLikePayload>({
